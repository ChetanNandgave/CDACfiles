		...
		do {
			...
			switch(choice) {
				...
				case 2:
					...
					try(StudentDao studentDao=new StudentDao()){
						studentDao.updateStudent1(rollno1, name);
						System.out.println("Student name Updated Scussefully");
					}catch(SQLException e) {
						e.printStackTrace();
					}
					break;
				case 3:
					...
					try(StudentDao studentDao=new StudentDao()){
						studentDao.updateStudent2(rollno2, email);
						System.out.println("Email is Successfulyy Updated");
					}catch(SQLException e) {
						e.printStackTrace();
					}
					break;
